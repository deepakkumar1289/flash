...
import com.coursecube.bookstoreweb.dto.Order;
import com.coursecube.bookstoreweb.dto.OrderInfo;
import com.coursecube.bookstoreweb.dto.OrderItem;
...
Order order=new Order(totalQuantity, orderDate,"U-11",totalQuantity,totalPrice,"New");
